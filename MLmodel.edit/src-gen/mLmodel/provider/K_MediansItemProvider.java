...
/**
 * This is the item provider adapter for a {@link mLmodel.K_Medians} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class K_MediansItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	 ...
	 * @generated
	 */
	public K_MediansItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/K_Medians"));
	}
	...
	public String getText(Object object) {
		Library_Clustering labelValue = ((K_Medians) object).getLibrary();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ? getString("_UI_K_Medians_type")
				: getString("_UI_K_Medians_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(K_Medians.class)) {
