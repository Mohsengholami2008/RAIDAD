...
/**
 * This is the item provider adapter for a {@link mLmodel.Neural_Networks} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class Neural_NetworksItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	 ...
	 * @generated
	 */
	public Neural_NetworksItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns Neural_Networks.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/Neural_Networks"));
	}
	...
	public String getText(Object object) {
		Neural_Libraries labelValue = ((Neural_Networks) object).getLibrary();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ? getString("_UI_Neural_Networks_type")
				: getString("_UI_Neural_Networks_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Neural_Networks.class)) {
