...
/**
 * This is the item provider adapter for a {@link mLmodel.Min_Max} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class Min_MaxItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	 ...
	 * @generated
	 */
	public Min_MaxItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/Min_Max"));
	}
	...
	public String getText(Object object) {
		Min_Max min_Max = (Min_Max) object;
		return getString("_UI_Min_Max_type") + " " + min_Max.isSave_file();
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Min_Max.class)) {
		case MLmodelPackage.MIN_MAX__SAVE_FILE:
		case MLmodelPackage.MIN_MAX__PRINT_DATA:
