...
/**
 * This is the item provider adapter for a {@link mLmodel.OneHot} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class OneHotItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	 ...
	 * @generated
	 */
	public OneHotItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(MLmodelPackage.Literals.ONE_HOT__ONEHOT_ARGUMANS);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/OneHot"));
	}
	...
	public String getText(Object object) {
		OneHot oneHot = (OneHot) object;
		return getString("_UI_OneHot_type") + " " + oneHot.isSave_file();
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(OneHot.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(MLmodelPackage.Literals.ONE_HOT__ONEHOT_ARGUMANS,
				MLmodelFactory.eINSTANCE.createDrop()));

		newChildDescriptors.add(createChildParameter(MLmodelPackage.Literals.ONE_HOT__ONEHOT_ARGUMANS,
				MLmodelFactory.eINSTANCE.createCategories()));

		newChildDescriptors.add(createChildParameter(MLmodelPackage.Literals.ONE_HOT__ONEHOT_ARGUMANS,
				MLmodelFactory.eINSTANCE.createSparse()));

		newChildDescriptors.add(createChildParameter(MLmodelPackage.Literals.ONE_HOT__ONEHOT_ARGUMANS,
				MLmodelFactory.eINSTANCE.createHandle_Unk()));
	}
