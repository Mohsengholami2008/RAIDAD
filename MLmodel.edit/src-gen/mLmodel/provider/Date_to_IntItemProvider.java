...
/**
 * This is the item provider adapter for a {@link mLmodel.Date_to_Int} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class Date_to_IntItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	 ...
	 * @generated
	 */
	public Date_to_IntItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(MLmodelPackage.Literals.DATE_TO_INT__DATE_COMP);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/Date_to_Int"));
	}
	...
	public String getText(Object object) {
		Date_to_Int date_to_Int = (Date_to_Int) object;
		return getString("_UI_Date_to_Int_type") + " " + date_to_Int.isSave_file();
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Date_to_Int.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(MLmodelPackage.Literals.DATE_TO_INT__DATE_COMP,
				MLmodelFactory.eINSTANCE.createYear()));

		newChildDescriptors.add(createChildParameter(MLmodelPackage.Literals.DATE_TO_INT__DATE_COMP,
				MLmodelFactory.eINSTANCE.createMonth()));

		newChildDescriptors.add(createChildParameter(MLmodelPackage.Literals.DATE_TO_INT__DATE_COMP,
				MLmodelFactory.eINSTANCE.createDay()));
	}
