...
/**
 * This is the item provider adapter for a {@link mLmodel.DBSCAN} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DBSCANItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addPPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_DBSCAN_p_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_DBSCAN_p_feature", "_UI_DBSCAN_type"),
						MLmodelPackage.Literals.DBSCAN__P, true, false, false, ItemPropertyDescriptor.REAL_VALUE_IMAGE,
						null, null));
	}
	...
	public String getText(Object object) {
		Library_Clustering labelValue = ((DBSCAN) object).getLibrary();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ? getString("_UI_DBSCAN_type")
