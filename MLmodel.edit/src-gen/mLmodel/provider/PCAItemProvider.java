...
/**
 * This is the item provider adapter for a {@link mLmodel.PCA} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PCAItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	 ...
	 * @generated
	 */
	public PCAItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(MLmodelPackage.Literals.PCA__PCA_ARGUMANS);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/PCA"));
	}
	...
	public String getText(Object object) {
		PCA pca = (PCA) object;
		return getString("_UI_PCA_type") + " " + pca.isSave_file();
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(PCA.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(MLmodelPackage.Literals.PCA__PCA_ARGUMANS,
				MLmodelFactory.eINSTANCE.createComponent()));

		newChildDescriptors.add(createChildParameter(MLmodelPackage.Literals.PCA__PCA_ARGUMANS,
				MLmodelFactory.eINSTANCE.createVarience()));
	}
