...
/**
 * This is the item provider adapter for a {@link mLmodel.CSV} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CSVItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(MLmodelPackage.Literals.CSV__CSV_ARGUMANS);
		}
	...
	public String getText(Object object) {
		CSV csv = (CSV) object;
		return getString("_UI_CSV_type") + " " + csv.isSave_file();
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(CSV.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(
				createChildParameter(MLmodelPackage.Literals.CSV__CSV_ARGUMANS, MLmodelFactory.eINSTANCE.createSep()));

		newChildDescriptors.add(createChildParameter(MLmodelPackage.Literals.CSV__CSV_ARGUMANS,
				MLmodelFactory.eINSTANCE.createNrows()));

		newChildDescriptors.add(createChildParameter(MLmodelPackage.Literals.CSV__CSV_ARGUMANS,
				MLmodelFactory.eINSTANCE.createHeadCSV()));
	}
