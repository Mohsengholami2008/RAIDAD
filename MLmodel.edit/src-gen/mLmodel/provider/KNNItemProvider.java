...
/**
 * This is the item provider adapter for a {@link mLmodel.KNN} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class KNNItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addKPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_KNN_k_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_KNN_k_feature", "_UI_KNN_type"),
						MLmodelPackage.Literals.KNN__K, true, false, false, ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
						null, null));
	}
	...
	public String getText(Object object) {
		KNN knn = (KNN) object;
		return getString("_UI_KNN_type") + " " + knn.getK();
	}
