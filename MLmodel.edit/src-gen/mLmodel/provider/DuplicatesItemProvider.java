...
/**
 * This is the item provider adapter for a {@link mLmodel.Duplicates} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DuplicatesItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	 ...
	 * @generated
	 */
	public DuplicatesItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(MLmodelPackage.Literals.DUPLICATES__DUPLICATES_ARGUMANS);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/Duplicates"));
	}
	...
	public String getText(Object object) {
		Duplicates duplicates = (Duplicates) object;
		return getString("_UI_Duplicates_type") + " " + duplicates.isSave_file();
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Duplicates.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(MLmodelPackage.Literals.DUPLICATES__DUPLICATES_ARGUMANS,
				MLmodelFactory.eINSTANCE.createKeep()));
	}
