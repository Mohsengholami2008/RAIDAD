...
/**
 * This is the item provider adapter for a {@link mLmodel.Excel} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ExcelItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(MLmodelPackage.Literals.EXCEL__EXCEL_ARGUMENTS);
		}
	...
	public String getText(Object object) {
		...
		return getString("_UI_Excel_type") + " " + excel.isSave_file();
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Excel.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(MLmodelPackage.Literals.EXCEL__EXCEL_ARGUMENTS,
				MLmodelFactory.eINSTANCE.createHeader_Ex()));

		newChildDescriptors.add(createChildParameter(MLmodelPackage.Literals.EXCEL__EXCEL_ARGUMENTS,
				MLmodelFactory.eINSTANCE.createSheet_Na_Excel()));
	}
