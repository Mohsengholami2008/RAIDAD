...
/**
 * This is the item provider adapter for a {@link mLmodel.Property} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PropertyItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addDatasourcePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Property_datasource_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Property_datasource_feature",
								"_UI_Property_type"),
						MLmodelPackage.Literals.PROPERTY__DATASOURCE, true, false, true, null, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Property_name_feature",
								"_UI_Property_type"),
						MLmodelPackage.Literals.PROPERTY__NAME, true, false, false,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Property_type_feature",
								"_UI_Property_type"),
						MLmodelPackage.Literals.PROPERTY__TYPE, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addReadOnlyPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Property_readOnly_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Property_readOnly_feature",
								"_UI_Property_type"),
						MLmodelPackage.Literals.PROPERTY__READ_ONLY, true, false, false,
	...
	protected void addWriteOnlyPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Property_writeOnly_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Property_writeOnly_feature",
								"_UI_Property_type"),
						MLmodelPackage.Literals.PROPERTY__WRITE_ONLY, true, false, false,
						ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Property_observable_feature",
								"_UI_Property_type"),
						MLmodelPackage.Literals.PROPERTY__OBSERVABLE, true, false, false,
						ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE, null, null));
	}
