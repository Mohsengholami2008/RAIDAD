 ...
 * </p>
 * <ul>
 *   <li>{@link mymohsenmodel.impl.RootImpl#getName <em>Name</em>}</li>
 *   <li>{@link mymohsenmodel.impl.RootImpl#getProcess <em>Process</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RootImpl extends MinimalEObjectImpl.Container implements Root {
	 ...
	 * @ordered
	 */
	protected mymohsenmodel.Process process;
	 ...
	 * @generated
	 */
	public mymohsenmodel.Process getProcess() {
		return process;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetProcess(mymohsenmodel.Process newProcess, NotificationChain msgs) {
		mymohsenmodel.Process oldProcess = process;
		process = newProcess;
		if (eNotificationRequired()) {
	 ...
	 * @generated
	 */
	public void setProcess(mymohsenmodel.Process newProcess) {
	...
	public void eSet(int featureID, Object newValue) {
		...
		case MLmodelPackage.ROOT__NAME:
			...
			return;
		case MLmodelPackage.ROOT__PROCESS:
			setProcess((mymohsenmodel.Process) newValue);
			return;
		}
	...
	public void eUnset(int featureID) {
		...
		case MLmodelPackage.ROOT__NAME:
			...
			return;
		case MLmodelPackage.ROOT__PROCESS:
			setProcess((mymohsenmodel.Process) null);
			return;
		}
