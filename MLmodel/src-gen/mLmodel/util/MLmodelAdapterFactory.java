...
public class MLmodelAdapterFactory extends AdapterFactoryImpl {
	...
	protected MLmodelSwitch<Adapter> modelSwitch = new MLmodelSwitch<Adapter>() {
		...
		@Override
		public Adapter caseOnlineAlert(OnlineAlert object) {
			return createOnlineAlertAdapter();
		}

		@Override
		public Adapter caseEmail_Alert(Email_Alert object) {
			return createEmail_AlertAdapter();
		}

		@Override
		public Adapter caseMQTT_Alert(MQTT_Alert object) {
			return createMQTT_AlertAdapter();
		}

		@Override
		public Adapter caseLog_Alert(Log_Alert object) {
			return createLog_AlertAdapter();
		}
	...
	/**
	 * Creates a new adapter for an object of class '{@link mLmodel.OnlineAlert <em>Online Alert</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createOnlineAlertAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link mLmodel.Email_Alert <em>Email Alert</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link mLmodel.MQTT_Alert <em>MQTT Alert</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link mLmodel.Log_Alert <em>Log Alert</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link mLmodel.ARIMA <em>ARIMA</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
