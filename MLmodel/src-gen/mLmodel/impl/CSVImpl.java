 ...
 * </p>
 * <ul>
 *   <li>{@link mLmodel.impl.CSVImpl#getAfter <em>After</em>}</li>
 *   <li>{@link mLmodel.impl.CSVImpl#getBefore <em>Before</em>}</li>
 *   <li>{@link mLmodel.impl.CSVImpl#getRegular <em>Regular</em>}</li>
 *   <li>{@link mLmodel.impl.CSVImpl#isSave_file <em>Save file</em>}</li>
 *   <li>{@link mLmodel.impl.CSVImpl#isPrint_data <em>Print data</em>}</li>
 *   <li>{@link mLmodel.impl.CSVImpl#getRole <em>Role</em>}</li>
 *   <li>{@link mLmodel.impl.CSVImpl#getCsv_argumans <em>Csv argumans</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CSVImpl extends MinimalEObjectImpl.Container implements CSV {
	...
	public void setSave_file(boolean newSave_file) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MLmodelPackage.CSV__SAVE_FILE, oldSave_file,
					save_file));
	}
	...
	public void setPrint_data(boolean newPrint_data) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MLmodelPackage.CSV__PRINT_DATA, oldPrint_data,
					print_data));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case MLmodelPackage.CSV__REGULAR:
			return getRegular();
		case MLmodelPackage.CSV__SAVE_FILE:
			return isSave_file();
		case MLmodelPackage.CSV__PRINT_DATA:
			return isPrint_data();
		case MLmodelPackage.CSV__ROLE:
			return getRole();
		case MLmodelPackage.CSV__CSV_ARGUMANS:
