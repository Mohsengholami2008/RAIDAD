...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Robust Scaling</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link mLmodel.impl.Robust_ScalingImpl#getAfter <em>After</em>}</li>
 *   <li>{@link mLmodel.impl.Robust_ScalingImpl#getBefore <em>Before</em>}</li>
 *   <li>{@link mLmodel.impl.Robust_ScalingImpl#getRegular <em>Regular</em>}</li>
 *   <li>{@link mLmodel.impl.Robust_ScalingImpl#isSave_file <em>Save file</em>}</li>
 *   <li>{@link mLmodel.impl.Robust_ScalingImpl#isPrint_data <em>Print data</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Robust_ScalingImpl extends MinimalEObjectImpl.Container implements Robust_Scaling {
	/**
	...
	protected EClass eStaticClass() {
		return MLmodelPackage.Literals.ROBUST_SCALING;
	}
		...
		if (after != null && after.eIsProxy()) {
			...
			if (after != oldAfter) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, MLmodelPackage.ROBUST_SCALING__AFTER,
							oldAfter, after));
			}
		}
		return after;
	...
	public NotificationChain basicSetAfter(Cycle newAfter, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					MLmodelPackage.ROBUST_SCALING__AFTER, oldAfter, newAfter);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setAfter(Cycle newAfter) {
		if (newAfter != after) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, MLmodelPackage.ROBUST_SCALING__AFTER, newAfter,
					newAfter));
	}
	...
	public Cycle getBefore() {
		if (before != null && before.eIsProxy()) {
			...
			if (before != oldBefore) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, MLmodelPackage.ROBUST_SCALING__BEFORE,
							oldBefore, before));
			}
		}
		return before;
	...
	public NotificationChain basicSetBefore(Cycle newBefore, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					MLmodelPackage.ROBUST_SCALING__BEFORE, oldBefore, newBefore);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	...
	public void setBefore(Cycle newBefore) {
		if (newBefore != before) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, MLmodelPackage.ROBUST_SCALING__BEFORE, newBefore,
					newBefore));
	}
	...
	public EList<Regular> getRegular() {
		if (regular == null) {
			regular = new EObjectResolvingEList<Regular>(Regular.class, this, MLmodelPackage.ROBUST_SCALING__REGULAR);
		}
		return regular;
	}
	...
	public void setSave_file(boolean newSave_file) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MLmodelPackage.ROBUST_SCALING__SAVE_FILE,
	...
	public void setPrint_data(boolean newPrint_data) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MLmodelPackage.ROBUST_SCALING__PRINT_DATA,
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case MLmodelPackage.ROBUST_SCALING__AFTER:
			if (after != null)
				msgs = ((InternalEObject) after).eInverseRemove(this, MLmodelPackage.CYCLE__BEFORE, Cycle.class, msgs);
			return basicSetAfter((Cycle) otherEnd, msgs);
		case MLmodelPackage.ROBUST_SCALING__BEFORE:
			if (before != null)
				msgs = ((InternalEObject) before).eInverseRemove(this, MLmodelPackage.CYCLE__AFTER, Cycle.class, msgs);
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case MLmodelPackage.ROBUST_SCALING__REGULAR:
			return getRegular();
		case MLmodelPackage.ROBUST_SCALING__SAVE_FILE:
			return isSave_file();
		case MLmodelPackage.ROBUST_SCALING__PRINT_DATA:
			return isPrint_data();
		}
