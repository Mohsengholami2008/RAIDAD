...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Perceptron</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 ...
 * @generated
 */
public class PerceptronImpl extends MinimalEObjectImpl.Container implements Perceptron {
	/**
	...
	protected EClass eStaticClass() {
		return MLmodelPackage.Literals.PERCEPTRON;
	}
		...
		if (after != null && after.eIsProxy()) {
			...
			if (after != oldAfter) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, MLmodelPackage.PERCEPTRON__AFTER,
							oldAfter, after));
			}
		}
		return after;
	...
	public NotificationChain basicSetAfter(Cycle newAfter, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					MLmodelPackage.PERCEPTRON__AFTER, oldAfter, newAfter);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setAfter(Cycle newAfter) {
		if (newAfter != after) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, MLmodelPackage.PERCEPTRON__AFTER, newAfter,
					newAfter));
	}
	...
	public Cycle getBefore() {
		if (before != null && before.eIsProxy()) {
			...
			if (before != oldBefore) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, MLmodelPackage.PERCEPTRON__BEFORE,
							oldBefore, before));
			}
		}
		return before;
	...
	public NotificationChain basicSetBefore(Cycle newBefore, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					MLmodelPackage.PERCEPTRON__BEFORE, oldBefore, newBefore);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	...
	public void setBefore(Cycle newBefore) {
		if (newBefore != before) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, MLmodelPackage.PERCEPTRON__BEFORE, newBefore,
					newBefore));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case MLmodelPackage.PERCEPTRON__AFTER:
			if (after != null)
				msgs = ((InternalEObject) after).eInverseRemove(this, MLmodelPackage.CYCLE__BEFORE, Cycle.class, msgs);
