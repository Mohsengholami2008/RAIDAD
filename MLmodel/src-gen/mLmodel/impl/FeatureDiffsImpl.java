...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Feature Diffs</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link mLmodel.impl.FeatureDiffsImpl#getAfter <em>After</em>}</li>
 *   <li>{@link mLmodel.impl.FeatureDiffsImpl#getBefore <em>Before</em>}</li>
 *   <li>{@link mLmodel.impl.FeatureDiffsImpl#getRegular <em>Regular</em>}</li>
 *   <li>{@link mLmodel.impl.FeatureDiffsImpl#isSave_file <em>Save file</em>}</li>
 *   <li>{@link mLmodel.impl.FeatureDiffsImpl#isPrint_data <em>Print data</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FeatureDiffsImpl extends MinimalEObjectImpl.Container implements FeatureDiffs {
	/**
	...
	protected EClass eStaticClass() {
		return MLmodelPackage.Literals.FEATURE_DIFFS;
	}
		...
		if (after != null && after.eIsProxy()) {
			...
			if (after != oldAfter) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, MLmodelPackage.FEATURE_DIFFS__AFTER,
							oldAfter, after));
			}
		}
		return after;
	...
	public NotificationChain basicSetAfter(Cycle newAfter, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					MLmodelPackage.FEATURE_DIFFS__AFTER, oldAfter, newAfter);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setAfter(Cycle newAfter) {
		if (newAfter != after) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, MLmodelPackage.FEATURE_DIFFS__AFTER, newAfter,
					newAfter));
	}
	...
	public Cycle getBefore() {
		if (before != null && before.eIsProxy()) {
			...
			if (before != oldBefore) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, MLmodelPackage.FEATURE_DIFFS__BEFORE,
							oldBefore, before));
			}
		}
		return before;
	...
	public NotificationChain basicSetBefore(Cycle newBefore, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					MLmodelPackage.FEATURE_DIFFS__BEFORE, oldBefore, newBefore);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	...
	public void setBefore(Cycle newBefore) {
		if (newBefore != before) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, MLmodelPackage.FEATURE_DIFFS__BEFORE, newBefore,
					newBefore));
	}
	...
	public EList<Regular> getRegular() {
		if (regular == null) {
			regular = new EObjectResolvingEList<Regular>(Regular.class, this, MLmodelPackage.FEATURE_DIFFS__REGULAR);
		}
		return regular;
	}
	...
	public void setSave_file(boolean newSave_file) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MLmodelPackage.FEATURE_DIFFS__SAVE_FILE, oldSave_file,
					save_file));
	}
	...
	public void setPrint_data(boolean newPrint_data) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MLmodelPackage.FEATURE_DIFFS__PRINT_DATA,
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case MLmodelPackage.FEATURE_DIFFS__AFTER:
			if (after != null)
				msgs = ((InternalEObject) after).eInverseRemove(this, MLmodelPackage.CYCLE__BEFORE, Cycle.class, msgs);
			return basicSetAfter((Cycle) otherEnd, msgs);
		case MLmodelPackage.FEATURE_DIFFS__BEFORE:
			if (before != null)
				msgs = ((InternalEObject) before).eInverseRemove(this, MLmodelPackage.CYCLE__AFTER, Cycle.class, msgs);
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case MLmodelPackage.FEATURE_DIFFS__REGULAR:
			return getRegular();
		case MLmodelPackage.FEATURE_DIFFS__SAVE_FILE:
			return isSave_file();
		case MLmodelPackage.FEATURE_DIFFS__PRINT_DATA:
			return isPrint_data();
		}
