...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Random State RF</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link mLmodel.impl.Random_State_RFImpl#getRandom_state <em>Random state</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Random_State_RFImpl extends MinimalEObjectImpl.Container implements Random_State_RF {
	/**
	...
	protected EClass eStaticClass() {
		return MLmodelPackage.Literals.RANDOM_STATE_RF;
	}
	...
	public void setRandom_state(int newRandom_state) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MLmodelPackage.RANDOM_STATE_RF__RANDOM_STATE,
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case MLmodelPackage.RANDOM_STATE_RF__RANDOM_STATE:
