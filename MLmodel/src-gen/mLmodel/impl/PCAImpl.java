...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>PCA</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link mLmodel.impl.PCAImpl#getAfter <em>After</em>}</li>
 *   <li>{@link mLmodel.impl.PCAImpl#getBefore <em>Before</em>}</li>
 *   <li>{@link mLmodel.impl.PCAImpl#getRegular <em>Regular</em>}</li>
 *   <li>{@link mLmodel.impl.PCAImpl#isSave_file <em>Save file</em>}</li>
 *   <li>{@link mLmodel.impl.PCAImpl#isPrint_data <em>Print data</em>}</li>
 *   <li>{@link mLmodel.impl.PCAImpl#getPca_argumans <em>Pca argumans</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PCAImpl extends MinimalEObjectImpl.Container implements PCA {
	/**
	...
	/**
	 * The cached value of the '{@link #getPca_argumans() <em>Pca argumans</em>}' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getPca_argumans()
	 * @generated
	 * @ordered
	 */
	protected EList<PCA_Argumans> pca_argumans;
	...
	protected EClass eStaticClass() {
		return MLmodelPackage.Literals.PCA;
	}
		...
		if (after != null && after.eIsProxy()) {
			...
			if (after != oldAfter) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, MLmodelPackage.PCA__AFTER, oldAfter,
							after));
			}
		}
		return after;
	...
	public NotificationChain basicSetAfter(Cycle newAfter, NotificationChain msgs) {
		...
		after = newAfter;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MLmodelPackage.PCA__AFTER,
					oldAfter, newAfter);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setAfter(Cycle newAfter) {
		if (newAfter != after) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, MLmodelPackage.PCA__AFTER, newAfter, newAfter));
	}
	...
	public Cycle getBefore() {
		if (before != null && before.eIsProxy()) {
			...
			if (before != oldBefore) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, MLmodelPackage.PCA__BEFORE, oldBefore,
							before));
			}
		}
		return before;
	...
	public NotificationChain basicSetBefore(Cycle newBefore, NotificationChain msgs) {
		...
		before = newBefore;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MLmodelPackage.PCA__BEFORE,
					oldBefore, newBefore);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setBefore(Cycle newBefore) {
		if (newBefore != before) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, MLmodelPackage.PCA__BEFORE, newBefore, newBefore));
	}
	...
	public EList<Regular> getRegular() {
		if (regular == null) {
			regular = new EObjectResolvingEList<Regular>(Regular.class, this, MLmodelPackage.PCA__REGULAR);
		}
		return regular;
	}
	...
	public void setSave_file(boolean newSave_file) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MLmodelPackage.PCA__SAVE_FILE, oldSave_file,
					save_file));
	}
	...
	public void setPrint_data(boolean newPrint_data) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MLmodelPackage.PCA__PRINT_DATA, oldPrint_data,
					print_data));
	}
	 ...
	 * @generated
	 */
	public EList<PCA_Argumans> getPca_argumans() {
		if (pca_argumans == null) {
			pca_argumans = new EObjectContainmentEList<PCA_Argumans>(PCA_Argumans.class, this,
					MLmodelPackage.PCA__PCA_ARGUMANS);
		}
		return pca_argumans;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case MLmodelPackage.PCA__AFTER:
			if (after != null)
				msgs = ((InternalEObject) after).eInverseRemove(this, MLmodelPackage.CYCLE__BEFORE, Cycle.class, msgs);
			return basicSetAfter((Cycle) otherEnd, msgs);
		case MLmodelPackage.PCA__BEFORE:
			if (before != null)
				msgs = ((InternalEObject) before).eInverseRemove(this, MLmodelPackage.CYCLE__AFTER, Cycle.class, msgs);
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		...
		case MLmodelPackage.PCA__PCA_ARGUMANS:
			return ((InternalEList<?>) getPca_argumans()).basicRemove(otherEnd, msgs);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case MLmodelPackage.PCA__REGULAR:
			return getRegular();
		case MLmodelPackage.PCA__SAVE_FILE:
			return isSave_file();
		case MLmodelPackage.PCA__PRINT_DATA:
			return isPrint_data();
		case MLmodelPackage.PCA__PCA_ARGUMANS:
			return getPca_argumans();
		}
	...
	public void eSet(int featureID, Object newValue) {
		...
		case MLmodelPackage.PCA__PRINT_DATA:
			...
			return;
		case MLmodelPackage.PCA__PCA_ARGUMANS:
			getPca_argumans().clear();
			getPca_argumans().addAll((Collection<? extends PCA_Argumans>) newValue);
			return;
		}
	...
	public boolean eIsSet(int featureID) {
		...
		case MLmodelPackage.PCA__PCA_ARGUMANS:
			return pca_argumans != null && !pca_argumans.isEmpty();
		}
