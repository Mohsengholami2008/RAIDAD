...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Duplicates</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link mLmodel.impl.DuplicatesImpl#getAfter <em>After</em>}</li>
 *   <li>{@link mLmodel.impl.DuplicatesImpl#getBefore <em>Before</em>}</li>
 *   <li>{@link mLmodel.impl.DuplicatesImpl#getRegular <em>Regular</em>}</li>
 *   <li>{@link mLmodel.impl.DuplicatesImpl#isSave_file <em>Save file</em>}</li>
 *   <li>{@link mLmodel.impl.DuplicatesImpl#isPrint_data <em>Print data</em>}</li>
 *   <li>{@link mLmodel.impl.DuplicatesImpl#getDuplicates_argumans <em>Duplicates argumans</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DuplicatesImpl extends MinimalEObjectImpl.Container implements Duplicates {
	/**
	...
	/**
	 * The cached value of the '{@link #getDuplicates_argumans() <em>Duplicates argumans</em>}' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getDuplicates_argumans()
	 * @generated
	 * @ordered
	 */
	protected EList<Duplicates_Argumans> duplicates_argumans;
	...
	protected EClass eStaticClass() {
		return MLmodelPackage.Literals.DUPLICATES;
	}
		...
		if (after != null && after.eIsProxy()) {
			...
			if (after != oldAfter) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, MLmodelPackage.DUPLICATES__AFTER,
							oldAfter, after));
			}
		}
		return after;
	...
	public NotificationChain basicSetAfter(Cycle newAfter, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					MLmodelPackage.DUPLICATES__AFTER, oldAfter, newAfter);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setAfter(Cycle newAfter) {
		if (newAfter != after) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, MLmodelPackage.DUPLICATES__AFTER, newAfter,
					newAfter));
	}
	...
	public Cycle getBefore() {
		if (before != null && before.eIsProxy()) {
			...
			if (before != oldBefore) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, MLmodelPackage.DUPLICATES__BEFORE,
							oldBefore, before));
			}
		}
		return before;
	...
	public NotificationChain basicSetBefore(Cycle newBefore, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					MLmodelPackage.DUPLICATES__BEFORE, oldBefore, newBefore);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	...
	public void setBefore(Cycle newBefore) {
		if (newBefore != before) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, MLmodelPackage.DUPLICATES__BEFORE, newBefore,
					newBefore));
	}
	...
	public EList<Regular> getRegular() {
		if (regular == null) {
			regular = new EObjectResolvingEList<Regular>(Regular.class, this, MLmodelPackage.DUPLICATES__REGULAR);
		}
		return regular;
	}
	...
	public void setSave_file(boolean newSave_file) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MLmodelPackage.DUPLICATES__SAVE_FILE, oldSave_file,
					save_file));
	}
	...
	public void setPrint_data(boolean newPrint_data) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MLmodelPackage.DUPLICATES__PRINT_DATA, oldPrint_data,
					print_data));
	}
	 ...
	 * @generated
	 */
	public EList<Duplicates_Argumans> getDuplicates_argumans() {
		if (duplicates_argumans == null) {
			duplicates_argumans = new EObjectContainmentEList<Duplicates_Argumans>(Duplicates_Argumans.class, this,
					MLmodelPackage.DUPLICATES__DUPLICATES_ARGUMANS);
		}
		return duplicates_argumans;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case MLmodelPackage.DUPLICATES__AFTER:
			if (after != null)
				msgs = ((InternalEObject) after).eInverseRemove(this, MLmodelPackage.CYCLE__BEFORE, Cycle.class, msgs);
			return basicSetAfter((Cycle) otherEnd, msgs);
		case MLmodelPackage.DUPLICATES__BEFORE:
			if (before != null)
				msgs = ((InternalEObject) before).eInverseRemove(this, MLmodelPackage.CYCLE__AFTER, Cycle.class, msgs);
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		...
		case MLmodelPackage.DUPLICATES__DUPLICATES_ARGUMANS:
			return ((InternalEList<?>) getDuplicates_argumans()).basicRemove(otherEnd, msgs);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case MLmodelPackage.DUPLICATES__REGULAR:
			return getRegular();
		case MLmodelPackage.DUPLICATES__SAVE_FILE:
			return isSave_file();
		case MLmodelPackage.DUPLICATES__PRINT_DATA:
			return isPrint_data();
		case MLmodelPackage.DUPLICATES__DUPLICATES_ARGUMANS:
			return getDuplicates_argumans();
		}
	...
	public void eSet(int featureID, Object newValue) {
		...
		case MLmodelPackage.DUPLICATES__PRINT_DATA:
			...
			return;
		case MLmodelPackage.DUPLICATES__DUPLICATES_ARGUMANS:
			getDuplicates_argumans().clear();
			getDuplicates_argumans().addAll((Collection<? extends Duplicates_Argumans>) newValue);
			return;
		}
	...
	public boolean eIsSet(int featureID) {
		...
		case MLmodelPackage.DUPLICATES__DUPLICATES_ARGUMANS:
			return duplicates_argumans != null && !duplicates_argumans.isEmpty();
		}
