 ...
 * </p>
 * <ul>
 *   <li>{@link mLmodel.impl.K_MeansImpl#getAfter <em>After</em>}</li>
 *   <li>{@link mLmodel.impl.K_MeansImpl#getBefore <em>Before</em>}</li>
 *   <li>{@link mLmodel.impl.K_MeansImpl#getLibrary <em>Library</em>}</li>
 *   <li>{@link mLmodel.impl.K_MeansImpl#getK <em>K</em>}</li>
 *   <li>{@link mLmodel.impl.K_MeansImpl#getMax_iter <em>Max iter</em>}</li>
 * </ul>
 *
 * @generated
 */
public class K_MeansImpl extends MinimalEObjectImpl.Container implements K_Means {
	/**
	...
	protected EClass eStaticClass() {
		return MLmodelPackage.Literals.KMEANS;
	}
		...
		if (after != null && after.eIsProxy()) {
			...
			if (after != oldAfter) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, MLmodelPackage.KMEANS__AFTER, oldAfter,
							after));
			}
		}
		return after;
	...
	public NotificationChain basicSetAfter(Cycle newAfter, NotificationChain msgs) {
		...
		after = newAfter;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MLmodelPackage.KMEANS__AFTER,
					oldAfter, newAfter);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setAfter(Cycle newAfter) {
		if (newAfter != after) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, MLmodelPackage.KMEANS__AFTER, newAfter, newAfter));
	}
	...
	public Cycle getBefore() {
		if (before != null && before.eIsProxy()) {
			...
			if (before != oldBefore) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, MLmodelPackage.KMEANS__BEFORE, oldBefore,
							before));
			}
		}
		return before;
	...
	public NotificationChain basicSetBefore(Cycle newBefore, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					MLmodelPackage.KMEANS__BEFORE, oldBefore, newBefore);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	...
	public void setBefore(Cycle newBefore) {
		if (newBefore != before) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, MLmodelPackage.KMEANS__BEFORE, newBefore, newBefore));
	}
	...
	public void setLibrary(Library_Clustering newLibrary) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MLmodelPackage.KMEANS__LIBRARY, oldLibrary, library));
	}
	...
	public void setK(int newK) {
		...
		k = newK;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MLmodelPackage.KMEANS__K, oldK, k));
	}
	...
	public void setMax_iter(int newMax_iter) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MLmodelPackage.KMEANS__MAX_ITER, oldMax_iter,
					max_iter));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case MLmodelPackage.KMEANS__AFTER:
			if (after != null)
				msgs = ((InternalEObject) after).eInverseRemove(this, MLmodelPackage.CYCLE__BEFORE, Cycle.class, msgs);
			return basicSetAfter((Cycle) otherEnd, msgs);
		case MLmodelPackage.KMEANS__BEFORE:
			if (before != null)
				msgs = ((InternalEObject) before).eInverseRemove(this, MLmodelPackage.CYCLE__AFTER, Cycle.class, msgs);
