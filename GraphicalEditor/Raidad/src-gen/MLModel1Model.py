...
def process_data(data=None,target_column=None, remove_duplicates_columns=None, impute_configurations=None, KNN_params=None, cv_folds=None): 
	executed_functions = []
	model = None	

	a =['Duplicates','Simple_Imputer','KNN','Cross_Validation','invalid']
